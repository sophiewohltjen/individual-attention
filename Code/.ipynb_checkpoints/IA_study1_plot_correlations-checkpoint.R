...
if (entrain){
  IA_comparecorrs_e <- read.csv(paste(base_directory,'/Analyses/study1/IA_',condition,'correlations_entrain.csv',sep=''))
  ...
  p1 <- ggplot(IA_comparecorrs_melt,aes(x=variable,y=value,)) + geom_boxplot(alpha=0.2,fill='black') + 
    ...
    scale_x_discrete(name="Pupil Responses to Deviant Tones",labels=c("Within Subjects","Between Subjects"))
